...
def testOddCount():
    ...
    assert(oddCount([ 1,2,2,2,2,2,2,2,2,2 ]) == 1) 
    assert(oddCount([ 3,5,7,9,11,13,15,17,20 ]) == 8) 
    assert(oddCount([ 2, 4, 5, 7 ]) == 2) 
    print('Passed!')
...
def testOddSum():
    ...
    assert(oddSum([ 1,1,1,1,1,2 ]) == 5)
    assert(oddSum([ 3, 2, 3, 2 ]) == 6)
    print('Passed!')
...
def testOddsOnly():
    ...
    assert(oddsOnly([ 11,12,13,13,13 ]) == [ 11,13,13,13 ])
    print('Passed!')
